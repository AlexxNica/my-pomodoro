...
module.exports = function setupHook(_ref) {
  ...
  var hashPrefix = _ref.hashPrefix;
  var mode = _ref.mode;
  var use = _ref.use;
  ...
  if (generateScopedName) {
    scopedName = typeof generateScopedName !== 'function' ? genericNames(generateScopedName, { context: context, hashPrefix: hashPrefix }) //  for example '[name]__[local]___[hash:base64:5]'
    : generateScopedName;
  } else {
    // small fallback
